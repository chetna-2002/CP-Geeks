...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div className="space-y-8 text-center lg:text-left pt-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                <Link href="/courses" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto h-14 px-8 text-base font-semibold gap-2 rounded-xl bg-primary hover:bg-primary/90 hover:scale-105 transition-all shadow-lg shadow-primary/20"
                  >
                    Explore Courses
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 pt-6 max-w-xl mx-auto lg:mx-0">
                {[
                  ...
                  <div
                    key={i}
                    className="rounded-2xl border border-border/40 bg-card/60 backdrop-blur-md p-3 sm:p-5 hover:border-primary/30 transition-all hover:-translate-y-1"
                  >
            ...
            <div className="relative hidden lg:flex items-center justify-center">
              <div className="relative w-full max-w-[520px] aspect-square">
                ...
                <div
                  className="absolute -bottom-6 -right-6 rounded-2xl border border-border/40 bg-card/80 backdrop-blur-md px-5 py-4 shadow-xl animate-float hidden xl:block"
                  style={{ animationDelay: "1s" }}
                >
      ...
      {/* Roadmap Section */}
      <section
        className="relative border-b border-border/30 py-16 sm:py-24 overflow-hidden"
        data-scroll-animate
        id="roadmap-section"
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20 space-y-4 sm:space-y-5">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-foreground">
              From Beginner to
              <span className="bg-gradient-to-r from-primary to-white bg-clip-text text-transparent block sm:inline">
                {" "}
                Top Engineer
              </span>
            </h2>
            ...
            <div className="space-y-8 sm:space-y-10">
              {roadmapSteps.map((step, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`${i % 2 === 0 ? "lg:text-right lg:pr-16" : "lg:order-2 lg:pl-16"}`}
                    >
              ...
              <div className="marquee mask-fade">
                <div className="marquee-track">
                  {[...placements, ...placements].map((p, i) => (
                    <div
                      key={i}
                      className="group relative min-w-[260px] sm:min-w-[300px] h-[180px] sm:h-[220px] rounded-3xl overflow-hidden border border-border/40 bg-card/40 backdrop-blur-xl hover:border-primary/40 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10"
                    >
                      <img
                      ...
                      <div className="absolute top-4 right-4 rounded-full border border-white/10 bg-black/40 backdrop-blur-md px-3 py-1 text-[10px] sm:text-xs text-white/80">
                        Placement
                      </div>
                    </div>
                  ))}
              ...
              <div className="marquee mask-fade mt-6 sm:mt-8 reverse">
                <div className="marquee-track">
                  {[...placements, ...placements].map((p, i) => (
                    <div
                      key={i}
                      className="group relative min-w-[220px] sm:min-w-[260px] h-[140px] sm:h-[180px] rounded-3xl overflow-hidden border border-border/40 bg-card/40 backdrop-blur-xl hover:border-primary/40 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10"
                    >
                      <img
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center justify-between px-6 pt-6">
                    <div
                      className={`rounded-full border px-3 py-1 text-[10px] sm:text-xs font-semibold ${categoryColors[course.category] || "bg-primary/10 text-primary border-primary/20"}`}
                    >
                  ...
                  <div className="relative z-10 flex-1 flex flex-col p-6">
                    ...
                    <div className="mt-4 sm:mt-5 flex flex-wrap gap-2">
                      {(course.what_you_learn || [])
                        ...
                        .map((item: string, idx: number) => (
                          <div
                            key={idx}
                            className="rounded-full border border-border/20 bg-background/30 px-3 py-1 text-[10px] sm:text-xs text-foreground/70"
                          >
                            {item}
                          </div>
                        ))}
                    ...
                    <div className="mt-auto pt-6 sm:pt-8 flex flex-row items-end justify-between">
                      <div>
                        <p className="text-[10px] sm:text-xs uppercase text-foreground/50">
                          Starting From
                        </p>
                      ...
                      <Link href={`/courses/${course.slug}`}>
                        <Button
                          size="lg"
                          className="rounded-xl px-4 sm:px-6 gap-2"
                        >
                          Explore
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 mt-5 sm:mt-6">
                    ...
                    <p className="mt-2 sm:mt-3 text-sm leading-relaxed text-foreground/65">
                      {item.description}
                    </p>
                  </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-20 sm:h-24 border-b border-border/20 bg-gradient-to-br from-primary/[0.08] via-primary/[0.03] to-transparent">
                    ...
                    />
                    <div className="absolute right-4 sm:right-5 top-4 sm:top-5 rounded-full border border-primary/20 bg-background/50 px-3 py-1 text-[10px] sm:text-xs font-medium text-primary backdrop-blur-md">
                      Mentor
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 flex flex-1 flex-col p-5 sm:p-6">
                    <div className="-mt-12 sm:-mt-14">
                      <img
                        ...
                        alt={instructor.name}
                        className="h-20 w-20 sm:h-24 sm:w-24 rounded-full border-4 border-background object-cover shadow-xl"
                      />
                      <div className="mt-4 sm:mt-5">
                        <h3 className="text-xl sm:text-2xl font-bold text-foreground transition-colors group-hover:text-primary">
                          {instructor.name}
                        </h3>
                    ...
                    <div className="mt-4 border-t border-border/20 pt-4 sm:pt-5">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-[10px] sm:text-xs uppercase tracking-wide text-foreground/50">
                            Learners Mentored
                          </p>
                      ...
                      <div className="mt-4 sm:mt-5 flex flex-wrap gap-2">
                        {["Mentorship", "Projects", "Career Growth"].map(
                          (tag, idx) => (
                            <div
                              key={idx}
                              className="rounded-full border border-border/20 bg-background/40 px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs text-foreground/65"
                            >
                              {tag}
                            </div>
                          )
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="flex w-full items-center justify-between px-4 sm:px-6 py-4 sm:py-5 text-left transition-all duration-300 hover:bg-primary/[0.03]"
                    >
                      <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div>
                          <h3 className="text-base sm:text-lg font-semibold text-foreground transition-colors group-hover:text-primary">
                            {faq.q}
                          </h3>
                        </div>
                      </div>
                      <div
                        className={`flex h-8 w-8 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl border border-border/30 bg-background/40 text-foreground/60 transition-all duration-300 ml-2 ${openFaq === i ? "rotate-180 border-primary/20 bg-primary/10 text-primary" : ""}`}
                      >
                        ▼
                      </div>
                    </button>
              ...
              <div className="relative overflow-hidden rounded-3xl border border-border/40 bg-card/50 backdrop-blur-xl p-6">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {["Live Cohorts", "DSA", "System Design", "Projects"].map(
                      (tag, idx) => (
                        <div
                          key={idx}
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
                {[
                  ...
                  <div
                    key={idx}
                    className="rounded-full border border-border/20 bg-background/40 px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-sm text-foreground/70"
                  >
                    {tag}
                  </div>
                ))}
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                <Link href="/signup" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto group gap-2 rounded-xl px-8 shadow-lg shadow-primary/20 transition-all duration-300 hover:scale-105 hover:gap-3"
                  >
                    Start Learning
                ...
                <Link href="/courses" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto rounded-xl border border-border/40 bg-white/5 px-8 text-foreground shadow-none backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-primary/[0.08] hover:text-foreground"
                  >
                    Explore Courses
                  </Button>
                </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.8fr_0.8fr] gap-10 sm:gap-12 border-b border-border/20 pb-10 sm:pb-12">
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 sm:h-14 sm:w-14 shrink-0 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 text-lg sm:text-xl font-black text-primary shadow-lg shadow-primary/10">
                  CG
                </div>
                <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <div
                    key={idx}
                    className="rounded-full border border-border/20 bg-card/40 px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs text-foreground/65 backdrop-blur-sm"
                  >
                    {tag}
                  </div>
                ))}
            ...
            <div>
              <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-foreground mb-4 sm:mb-5">
                Navigation
              </h4>
              <div className="flex flex-col gap-3 sm:gap-4 text-xs sm:text-sm">
                ...
                {user ? (
                  ...
                  <button
                    ...
                    className="group flex items-center gap-2 text-left text-foreground/60 transition-colors hover:text-primary cursor-pointer"
                  >
                    <span className="h-1.5 w-1.5 rounded-full bg-primary/50 transition-all group-hover:scale-125 group-hover:bg-primary" />
                    DSA Sheets
                  </button>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 sm:gap-4 text-xs sm:text-sm">
                ...
                <a
                  ...
                  className="group flex items-center gap-2 text-foreground/60 transition-colors hover:text-primary break-all"
                >
          ...
          <div className="flex flex-col items-center justify-between gap-5 pt-8 md:flex-row">
            ...
            <div className="flex items-center gap-4 w-full md:w-auto justify-center md:justify-end">
              <a
                ...
                className="group inline-flex items-center justify-center w-full md:w-auto gap-3 rounded-xl border border-border/30 bg-card/40 px-4 py-2.5 text-foreground/60 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-primary/[0.06] hover:text-primary"
              >
