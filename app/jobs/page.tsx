      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-foreground/65">
            Discover internships and engineering opportunities
    ...
    <section className="border-t border-border/20 py-14">
      ...
      <div className="mx-auto max-w-4xl px-4 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-foreground/65">
          Prepare for interviews, improve problem-solving,
          and strengthen your engineering fundamentals.
        </p>

        <Button
          size="lg"
          onClick={() => router.push('/courses')}
          className="mt-8 rounded-xl px-8 shadow-lg shadow-primary/20 transition-all duration-300 hover:scale-105"
        >
          Explore Courses
        </Button>
      </div>
