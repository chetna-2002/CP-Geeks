...
export default function TermsPage() {
  const sections = [
    ...
    },
    {
      ...
      content: [
        "For any questions, legal concerns, or inquiries regarding these terms, please contact us using the details below:"
      ],
      list: [
        "Name: Mannu",
        "GST Address: Begusarai, Bihar",
        "Contact Number: 7801930280",
        "Email: mannu.cpgeeks@gmail.com"
      ]
    }
  ];
          ...
          {/* <div className="mt-10 rounded-3xl border border-border/30 bg-card/40 backdrop-blur-xl p-8">
            <div className="flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <Mail className="h-4 w-4 text-primary" />
                  mannu.cpgeeks@gmail.com
                </div>
                <div className="text-sm text-foreground/60">Mannu • Begusarai, Bihar • +91 7801930280</div>
              </div>
            </div>
          </div> */}
